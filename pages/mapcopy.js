  ...
  function createPopUp(currentFeature) {
    ...
    if (popUps[0]) popUps[0].remove();
      ...
      const popup = new mapboxgl.Popup({ closeOnClick: false })
        ...
        .setHTML(` <img src="/placeholder.webp" style="height: 120px; width: 100%; object-fit: cover;"><h3 className=${styles.popup}>Sweetgreen</h3><h4>${currentFeature.properties.address}</h4>`)
        .addTo(map.current);
    };
...
return (
  <div className={styles.interactiveMap}>
    ...
    <h1>THIS IS /MAPCOPY, REFR TO <a href="/map">/MAP </a>for prod build</h1>
  </div>
